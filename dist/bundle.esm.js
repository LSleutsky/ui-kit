...
import { Dimensions, StyleSheet, ImageBackground, Image as Image$2, Platform, Pressable, View, Animated, Text as Text$1, Modal, ScrollView, TouchableOpacity, TouchableNativeFeedback, ActivityIndicator, TouchableWithoutFeedback, KeyboardAvoidingView, StatusBar, Easing, TextInput, PanResponder, LayoutAnimation, Keyboard, SafeAreaView as SafeAreaView$1, Switch as Switch$1, I18nManager } from 'react-native';
import React, { useCallback, useEffect, useMemo, useRef, Component, useState } from 'react';
import { AirbnbRating as AirbnbRating$1, Rating as Rating$1 } from 'react-native-ratings';
...
const BackgroundImage = ImageBackground || Image$2;
...
const AirbnbRating = (props) => {
    return React.createElement(AirbnbRating$1, Object.assign({}, props));
};
...
const Icon = (_a) => {
    ...
    var { testID = 'RNE__ICON__CONTAINER', type = 'material', name, size = 24, color: colorProp, iconStyle, iconProps, underlayColor = 'transparent', reverse = false, raised = false, containerStyle, reverseColor: reverseColorProp, disabled = false, disabledStyle, onPress, onLongPress, onPressIn, onPressOut, Component = onPress || onLongPress || onPressIn || onPressOut
        ? Pressable
        : View, solid = false, brand = false, theme = defaultTheme, pressableProps } = _a, rest = __rest$R(_a, ["testID", "type", "name", "size", "color", "iconStyle", "iconProps", "underlayColor", "reverse", "raised", "containerStyle", "reverseColor", "disabled", "disabledStyle", "onPress", "onLongPress", "onPressIn", "onPressOut", "Component", "solid", "brand", "theme", "pressableProps"]);
...
const Image$1 = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({}, pressableProps, { onPress, onPressIn, onPressOut, onLongPress }, { accessibilityIgnoresInvertColors: true, style: StyleSheet.flatten([styles$J.container, containerStyle]) }),
        ...
        React.createElement(Animated.View, { pointerEvents: hasImage ? 'none' : 'auto', accessibilityElementsHidden: hasImage, importantForAccessibility: hasImage ? 'no-hide-descendants' : 'yes', style: [
            ...
            React.createElement(View, { testID: "RNE__Image__placeholder", style: StyleSheet.flatten([
                ...
                ? PlaceholderContent
                : PlaceholderContent && (React.createElement(Text$1, { testID: "RNE__Image__Placeholder__Content" }, PlaceholderContent)))),
...
const Image = Object.assign(Image$1, {
    getSize: Image$2.getSize,
    getSizeWithHeaders: Image$2.getSizeWithHeaders,
    prefetch: Image$2.prefetch,
    abortPrefetch: Image$2.abortPrefetch,
    queryCache: Image$2.queryCache,
    resolveAssetSource: Image$2.resolveAssetSource,
});
...
const Avatar = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({ style: StyleSheet.flatten([
        ...
        icon && (React.createElement(Icon, { style: StyleSheet.flatten([iconStyle]), color: icon.color || 'white', name: icon.name || 'account', size: icon.size || iconSize, type: icon.type || 'material-community' })),
        title && (React.createElement(Text$1, { style: StyleSheet.flatten([
                styles$I.title,
                { fontSize: titleSize },
                titleStyle,
            ]) }, title)),
...
const Badge = (_a) => {
    ...
    var { containerStyle, textStyle, textProps, badgeStyle, onPress, onLongPress, onPressOut, onPressIn, Component = onPress || onLongPress || onPressIn || onPressOut
        ? Pressable
        : View, value, theme = defaultTheme, status = 'primary', pressableProps } = _a, rest = __rest$N(_a, ["containerStyle", "textStyle", "textProps", "badgeStyle", "onPress", "onLongPress", "onPressOut", "onPressIn", "Component", "value", "theme", "status", "pressableProps"]);
    const element = renderNode(Text$1, value, Object.assign({ style: StyleSheet.flatten([styles$G.text, textStyle && textStyle]) }, textProps));
    ...
    return (React.createElement(View, { style: [
        ...
        React.createElement(TouchableComponentInternal, Object.assign({ onPress: handleOnPress, delayPressIn: 0, activeOpacity: 0.3, accessibilityRole: "button", accessibilityState: accessibilityState, disabled: disabled, background: background }, rest),
            React.createElement(ViewComponent, Object.assign({}, linearGradientProps, { style: StyleSheet.flatten([
                ...
                loading && (React.createElement(ActivityIndicator, Object.assign({ style: StyleSheet.flatten([styles$E.loading, loadingStyle]), color: loadingProps.color, size: loadingProps.size }, loadingProps))),
                !loading &&
                    icon &&
                ...
                !loading &&
                    React.Children.toArray(children).map((child, index) => (React.createElement(React.Fragment, { key: index }, typeof child === 'string'
                        ? renderNode(Text$1, child, Object.assign({ style: Object.assign({}, titleStyle) }, titleProps))
                        : child)))))));
};
...
const Text = (_a) => {
    ...
    return (React.createElement(Text$1, Object.assign({ accessibilityRole: "text", style: StyleSheet.flatten([
        ...
        return (React.createElement(View, { key: i, style: StyleSheet.flatten([
            ...
            React.createElement(Component, Object.assign({ testID: "RNE__ButtonGroupItem", accessibilityState: {
                ...
                React.createElement(View, { style: StyleSheet.flatten([
                        ...
                        Object.assign({ fontSize: normalize(13), color: (_e = theme === null || theme === void 0 ? void 0 : theme.colors) === null || _e === void 0 ? void 0 : _e.grey2 }, Platform.select({
                            android: {},
                            default: {
                                fontWeight: '500',
                            },
...
const Divider = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        subHeader && orientation === 'horizontal' ? (React.createElement(Text$1, { style: StyleSheet.flatten([
                styles$A.subHeader,
                subHeaderStyle,
...
const CardDivider = (_a) => {
    ...
    return React.createElement(Divider, Object.assign({ style: StyleSheet.flatten([styles$z.divider, style]) }, rest));
};
...
const CardImage = (_a) => {
    ...
    return React.createElement(Image, Object.assign({ style: StyleSheet.flatten([styles$y.image, style]) }, props));
};
    ...
    return (React.createElement(Component, Object.assign({ accessibilityRole: "checkbox", accessibilityState: accessibilityState, testID: "RNE__CheckBox__Wrapper" }, rest, { disabled: disabled, onLongPress: onLongPress, onPress: onPress, style: StyleSheet.flatten([
        ...
        React.createElement(View, { style: StyleSheet.flatten([
            ...
            React.isValidElement(title)
                ? title
                : title !== '' &&
                    title && (React.createElement(Text, Object.assign({ testID: "RNE__CheckBox__Title", style: StyleSheet.flatten([
...
const Chip = (_a) => {
    ...
    return (React.createElement(Button$1, Object.assign({ titleStyle: StyleSheet.flatten([
...
const DialogLoading = ({ loadingStyle, loadingProps, theme = defaultTheme, }) => {
    var _a, _b, _c;
    return (React.createElement(View, { style: styles$w.loadingView },
...
const DialogTitle = ({ title, titleStyle, titleProps, }) => {
    return (React.createElement(Text$1, Object.assign({ style: StyleSheet.flatten([styles$v.title, titleStyle]), testID: "Dialog__Title" }, titleProps), title));
};
...
const DialogButton = (_a) => {
    ...
    return (React.createElement(Button$1, Object.assign({ style: { marginLeft: 5 }, titleStyle: StyleSheet.flatten([styles$u.buttonTitle, titleStyle]), containerStyle: {
            width: 'auto',
...
const DialogActions = ({ children, }) => {
    return (React.createElement(View, { style: styles$t.actionsView, testID: "Button__View" }, children));
};
...
const Overlay = (_a) => {
    ...
    return (React.createElement(ModalComponent, Object.assign({ visible: isVisible, onRequestClose: onBackdropPress, transparent: true }, rest),
        React.createElement(Pressable, Object.assign({ style: StyleSheet.flatten([styles$s.backdrop, backdropStyle]), onPress: onBackdropPress, testID: "RNE__Overlay__backdrop" }, pressableProps, { onPressOut, onPressIn, onLongPress })),
        React.createElement(KeyboardAvoidingView, { testID: "RNE__Overlay__Container", style: styles$s.container, pointerEvents: "box-none", behavior: getBehaviorType },
...
const DialogBase = (_a) => {
    ...
    return (React.createElement(Overlay, Object.assign({ isVisible: isVisible, onBackdropPress: onBackdropPress, overlayStyle: StyleSheet.flatten([styles$r.dialog, overlayStyle]), testID: "Internal__Overlay" }, rest), children));
};
...
const FAB = (_a) => {
    ...
    return (React.createElement(Animated.View, { style: StyleSheet.flatten([
        ...
        React.createElement(Button$1, Object.assign({ buttonStyle: StyleSheet.flatten([
                rest.title
                    ? size === 'small'
...
const Children = ({ style, placement, children, }) => (React.createElement(View, { style: StyleSheet.flatten([{ alignItems: ALIGN_STYLE[placement] }, style]) }, children == null || children === false
    ? null
    : children.text
        ? renderNode(Text$1, children.text, Object.assign({ numberOfLines: 1 }, children))
        : children.icon
...
const Header = (_a) => {
    ...
    var { hideStatusBar = false, statusBarProps, leftComponent, centerComponent, rightComponent, leftContainerStyle, centerContainerStyle, rightContainerStyle, backgroundColor, backgroundImage, backgroundImageStyle, containerStyle, placement = 'center', barStyle, children = [], linearGradientProps, ViewComponent = linearGradientProps || !backgroundImage
        ? View
        : ImageBackground, theme = defaultTheme, elevated, edges = ['left', 'top', 'right'] } = _a, rest = __rest$v(_a, ["hideStatusBar", "statusBarProps", "leftComponent", "centerComponent", "rightComponent", "leftContainerStyle", "centerContainerStyle", "rightContainerStyle", "backgroundColor", "backgroundImage", "backgroundImageStyle", "containerStyle", "placement", "barStyle", "children", "linearGradientProps", "ViewComponent", "theme", "elevated", "edges"]);
    React.useEffect(() => {
        if (linearGradientProps && !ViewComponent) {
            console.warn("You need to pass a ViewComponent to use linearGradientProps !\nExample: ViewComponent={require('react-native-linear-gradient')}");
        }
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(ViewComponent, Object.assign({ testID: "headerContainer" }, rest, { style: StyleSheet.flatten([
            ...
            React.createElement(SafeAreaView, { edges: edges, style: styles$p.headerSafeView },
...
const renderText$1 = (content, defaultProps, style) => renderNode(Text$1, content, Object.assign(Object.assign({}, defaultProps), { style: StyleSheet.flatten([style, defaultProps && defaultProps.style]) }));
...
const ListItemBase = (props) => {
    var _a, _b;
    const { containerStyle, onPress, onLongPress, Component = onPress || onLongPress ? Pressable : View, disabled, disabledStyle, bottomDivider, topDivider, pad = 16, linearGradientProps, ViewComponent = View, theme = defaultTheme, children } = props, rest = __rest$r(props, ["containerStyle", "onPress", "onLongPress", "Component", "disabled", "disabledStyle", "bottomDivider", "topDivider", "pad", "linearGradientProps", "ViewComponent", "theme", "children"]);
...
const ListItemInput = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(Input, Object.assign({ ref: ref, renderErrorMessage: false }, rest, { inputStyle: StyleSheet.flatten([styles$m.input, inputStyle]), inputContainerStyle: StyleSheet.flatten([
            styles$m.inputContainer,
            inputContainerStyle,
        ]), containerStyle: StyleSheet.flatten([styles$m.container, containerStyle]) })));
});
...
const ListItemCheckBox = (_a) => {
    ...
    return (React.createElement(CheckBox, Object.assign({}, rest, { containerStyle: StyleSheet.flatten([styles$l.container, containerStyle]) })));
};
...
const ListItemButtonGroup = (_a) => {
    ...
    return (React.createElement(ButtonGroup, Object.assign({}, rest, { containerStyle: StyleSheet.flatten([styles$k.container, containerStyle]) })));
};
const styles$k = StyleSheet.create({
    container: {
        flex: 1,
...
const ListItemSwipeable = (_a) => {
    ...
    return (React.createElement(View, { style: styles$h.container },
        React.createElement(View, { style: styles$h.actions },
            React.createElement(View, { style: [
                ...
                : leftContent),
            React.createElement(View, { style: styles$h.empty }),
            React.createElement(View, { style: [
                    {
                        width: rightWidth,
                        zIndex: 1,
...
const PricingButton = (_a) => {
    ...
    return (React.createElement(Button$1, Object.assign({ testID: "RNE__PricingButton", title: title, buttonStyle: StyleSheet.flatten([
            styles$g.button,
            buttonStyle,
...
const PricingCard = (_a) => {
    ...
    return (React.createElement(View, Object.assign({}, rest, { style: StyleSheet.flatten([
        ...
        React.createElement(View, { style: StyleSheet.flatten([
            ...
            React.createElement(Text, { style: StyleSheet.flatten([styles$f.pricingPrice, pricingStyle]) }, price), info === null || info === void 0 ? void 0 :
            info.map((item) => {
                var _a;
...
const styles$f = StyleSheet.create({
    ...
    pricingTitle: Object.assign({ textAlign: 'center', fontSize: normalize(30) }, Platform.select({
        android: Object.assign({}, fonts.android.black),
        default: {
            fontWeight: '800',
        },
    })),
    pricingPrice: Object.assign({ textAlign: 'center', marginTop: 10, marginBottom: 10, fontSize: normalize(40) }, Platform.select({
        android: Object.assign({}, fonts.android.bold),
        default: {
            fontWeight: '700',
        },
...
const Rating = () => {
    return React.createElement(Rating$1, null);
};
    ...
    render() {
        ...
        return (React.createElement(View, { testID: "RNE__SearchBar-wrapper", style: StyleSheet.flatten([
            ...
            React.createElement(Input, Object.assign({ testID: "RNE__SearchBar", renderErrorMessage: false }, attributes, { onFocus: this.onFocus, onBlur: this.onBlur, onChangeText: this.onChangeText, ref: (input) => {
                    this.input = input;
                }, inputStyle: StyleSheet.flatten([styles$e.input, inputStyle]), containerStyle: {
                    paddingHorizontal: 0,
                    ...
                    inputContainerStyle,
                ]), leftIcon: renderNode(Icon, searchIcon, defaultSearchIcon$2(theme)), leftIconContainerStyle: StyleSheet.flatten([
                    ...
                    !isEmpty &&
                        renderNode(Icon, clearIcon, Object.assign(Object.assign({}, defaultClearIcon$2(theme)), { key: 'cancel', onPress: this.clear }))), rightIconContainerStyle: StyleSheet.flatten([
            ...
            React.createElement(View, { style: StyleSheet.flatten([
                ...
                React.createElement(Pressable, Object.assign({ accessibilityRole: "button", onPress: this.cancel, disabled: buttonDisabled }, otherCancelButtonProps),
                    React.createElement(View, { style: StyleSheet.flatten([
                        ...
                        React.createElement(Text$1, { style: StyleSheet.flatten([
...
class SearchBarAndroid extends Component {
    constructor(props) {
        super(props);
        this.focus = () => {
            this.input.focus();
    ...
    render() {
        ...
        return (React.createElement(View, { testID: "RNE__SearchBar-wrapper", style: StyleSheet.flatten([
            ...
            React.createElement(Input, Object.assign({ testID: "RNE__SearchBar", renderErrorMessage: false }, attributes, { onFocus: this.onFocus, onBlur: this.onBlur, onChangeText: this.onChangeText, ref: (input) => {
                    this.input = input;
                }, containerStyle: { paddingHorizontal: 0 }, inputStyle: StyleSheet.flatten([styles$d.input, inputStyle]), inputContainerStyle: StyleSheet.flatten([
                    ...
                    : renderNode(Icon, searchIcon, defaultSearchIcon$1(theme)), leftIconContainerStyle: StyleSheet.flatten([
                    styles$d.leftIconContainerStyle,
                    leftIconContainerStyle,
                ]), rightIcon: React.createElement(View, { style: { flexDirection: 'row' } },
                    showLoading && (React.createElement(ActivityIndicator, Object.assign({ key: "loading", style: StyleSheet.flatten([{ marginRight: 5 }, loadingStyle]) }, otherLoadingProps))),
                    !isEmpty &&
                        renderNode(Icon, clearIcon, Object.assign(Object.assign({}, defaultClearIcon$1(theme)), { key: 'cancel', onPress: this.clear }))), rightIconContainerStyle: StyleSheet.flatten([
    ...
    render() {
        ...
        return (React.createElement(View, { testID: "RNE__SearchBar-wrapper", style: StyleSheet.flatten([
            ...
            React.createElement(Input, Object.assign({ testID: "RNE__SearchBar", renderErrorMessage: false }, attributes, { onFocus: this.onFocus, onBlur: this.onBlur, onChangeText: this.onChangeText, ref: (input) => {
                    ...
                    inputContainerStyle,
                ]), containerStyle: styles$c.inputContainer, leftIcon: renderNode(Icon, searchIcon, defaultSearchIcon(theme)), leftIconContainerStyle: StyleSheet.flatten([
...
const Slider = (_a) => {
    ...
    const appliedTrackStyle = StyleSheet.flatten([styles$a.track, trackStyle]);
    ...
    return (React.createElement(View, Object.assign({ testID: "RNE__Slider_Container" }, other, { style: StyleSheet.flatten([
        ...
        React.createElement(View, Object.assign({ testID: "RNE__Slider_TouchArea", style: StyleSheet.flatten([styles$a.touchArea, touchOverflowStyle]) }, panResponder.panHandlers), debugTouchArea === true && renderDebugThumbTouchRect(thumbStart))));
};
Slider.defaultProps = {
    value: 0,
    minimumValue: 0,
...
const SocialIcon = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({}, Object.assign(Object.assign({ onLongPress,
        ...
        React.createElement(View, { style: styles$9.wrapper },
...
const SpeedDial = (_a) => {
    ...
    return (React.createElement(View, { style: [styles$8.container, style], pointerEvents: "box-none" },
        ...
        React.createElement(SafeAreaView$1, { pointerEvents: "box-none", style: [
                {
...
const SpeedDialAction = (_a) => {
    ...
    return (React.createElement(Pressable, { onPress: labelPressable ? onPress : undefined, style: [
        ...
        title && React.createElement(Text$1, { style: [styles$7.title, titleStyle] }, title),
...
const Switch = (_a) => {
    ...
    return (React.createElement(Switch$1, Object.assign({ testID: "RNE__SWITCH", value: value, accessibilityState: {
            checked: value,
            disabled,
...
const TabViewBase = ({ value = 0, children, onChange = () => { }, onSwipeStart = () => { }, animationType = 'spring', animationConfig = {}, containerStyle, tabItemContainerStyle, disableSwipe = false, disableTransition = false, minSwipeRatio = 0.4, minSwipeSpeed = 1, }) => {
    ...
    return (React.createElement(View, { style: [styles$3.container, containerStyle], onLayout: ({ nativeEvent: { layout } }) => {
...
const FeaturedTile = (_a) => {
    var { title, icon, caption, imageSrc, containerStyle, imageContainerStyle, overlayContainerStyle, iconContainerStyle, titleStyle, captionStyle, ImageComponent = BackgroundImage, imageProps = {}, width = Dimensions.get('window').width, height = width * 0.8 } = _a, attributes = __rest$2(_a, ["title", "icon", "caption", "imageSrc", "containerStyle", "imageContainerStyle", "overlayContainerStyle", "iconContainerStyle", "titleStyle", "captionStyle", "ImageComponent", "imageProps", "width", "height"]);
    return (React.createElement(Pressable, Object.assign({}, attributes, { style: StyleSheet.flatten([
        ...
        React.createElement(ImageComponent, Object.assign({ resizeMode: "cover" }, imageProps, { source: imageSrc, style: StyleSheet.flatten([
            ...
            React.createElement(View, { style: StyleSheet.flatten([
                ...
                React.createElement(Text, { testID: "featuredTileTitle", h4: !titleStyle || !('fontSize' in titleStyle), style: StyleSheet.flatten([styles$2.text, titleStyle && titleStyle]) }, title),
...
const Tile = (_a) => {
    ...
    return (React.createElement(Pressable, Object.assign({}, Object.assign({ onPress, android_ripple: androidRipple(Color((_b = theme === null || theme === void 0 ? void 0 : theme.colors) === null || _b === void 0 ? void 0 : _b.primary).alpha(activeOpacity).rgb().toString()) }, attributes), { style: StyleSheet.flatten([
        ...
        React.createElement(View, { style: StyleSheet.flatten([
            ...
            React.createElement(Text, { testID: "tileTitle", h4: !titleStyle || !('fontSize' in titleStyle), style: StyleSheet.flatten([styles$1.text, titleStyle && titleStyle]), numberOfLines: titleNumberOfLines }, title),
            children)));
};
...
var Button = function (_a) {
    ...
    return (jsx(NativeButton, { buttonStyle: buttonStyle, containerStyle: containerStyle, icon: icon, iconPosition: icon && iconPosition, onPress: onPress, radius: radius, size: size, title: uppercase ? title.toUpperCase() : title, titleStyle: titleStyle }));
};
